...
5. The link of the repository can be found when you click on "Code" 
6. Later, you'll need to use Anaconda Prompt and add "Jupyter notebook" in the prompt. 
7. This would open the jupyter notebook that could be used to run and load the .ipynb files respectively. Therefore, you would be able to run the project at hand. 
